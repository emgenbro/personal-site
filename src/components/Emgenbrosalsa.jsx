...
Command: npx gltfjsx@6.2.3 public/emgenbro/emgenbrosalsa.gltf
*/
...
const EmgenbroModel = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/emgenbro/emgenbrosalsa.gltf')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature" position={[0, 0, -0.006]} rotation={[Math.PI / 2, 0, 0]}>
...
export default EmgenbroModel;
useGLTF.preload('/emgenbro/emgenbrosalsa.gltf')
